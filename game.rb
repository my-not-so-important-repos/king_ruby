...
class Game_Window < Gosu::Window
  ...
  def update
    # if game is over, return will restart game
    if game_over?
  ...
  def game_over?
    @game_over_red = true if @snake_red.player_dead?
    @game_over_blue = true if @snake_blue.player_dead?
    @game_over_red || @game_over_blue
  end
