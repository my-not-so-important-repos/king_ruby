class Snake
  ...
  alias_method :player_dead?, :player_dead
  ...
  def collision_checker
    ...
    if @snake_colliders.top_collision then
      @moving_up = false
    end
    if @snake_colliders.bottom_collision then
      @moving_up = true
    end
    if @snake_colliders.right_collision then
      @moving_right = false
    end
    if @snake_colliders.left_collision then
      @moving_right = true
    end
  end
